...
pub enum Event {
    ...
    ActiveSpecialV2 {
        workspace: Option<ActiveSpecial>,
        monitor_name: String,
    },
    ActiveLayout {
...
fn read_event(line: &str) -> Result<Event> {
    let Some((event_name, params)) = line.split_once(">>") else {
        bail!("Could not find separator in {line}")
    };
    Ok(match event_name {
        ...
        "activewindow" => {
            ...
            if class.is_empty() {
                Event::ActiveWindow { window: None }
            } else {
                Event::ActiveWindow {
        ...
        "activespecial" => {
            ...
            Event::ActiveSpecial {
                ...
                workspace_name: if workspace_name.is_empty() {
                    ...
                    Some(String::from(workspace_name))
                },
            }
        }
        "activespecialv2" => {
